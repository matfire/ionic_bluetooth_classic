...
| Param              | Type                                                                                      |
| ------------------ | ----------------------------------------------------------------------------------------- |
| **`eventName`**    | <code>'deviceConnectionStatusChanged'</code>                                              |
| **`listenerFunc`** | <code>({ data }: { data: <a href="#idevicestatus">IDeviceStatus</a>; }) =&gt; void</code> |
...
| Param              | Type                                                                                      |
| ------------------ | ----------------------------------------------------------------------------------------- |
| **`eventName`**    | <code>'deviceDataReceived'</code>                                                         |
| **`listenerFunc`** | <code>({ data }: { data: <a href="#idatareceived">IDataReceived</a>; }) =&gt; void</code> |
...
| Param              | Type                                                                              |
| ------------------ | --------------------------------------------------------------------------------- |
| **`eventName`**    | <code>'deviceDiscovered'</code>                                                   |
| **`listenerFunc`** | <code>({ device }: { device: <a href="#idevice">IDevice</a>; }) =&gt; void</code> |
...
| **`status`**   | <code><a href="#devicestatus">DeviceStatus</a></code> |
...
| Prop        | Type                                              |
| ----------- | ------------------------------------------------- |
| **`bytes`** | <code><a href="#uint8array">Uint8Array</a></code> |
...
| Members            | Value          |
| ------------------ | -------------- |
| **`DISCONNECTED`** | <code>0</code> |
| **`CONNECTED`**    | <code>1</code> |
| **`CONNECTING`**   | <code>2</code> |
